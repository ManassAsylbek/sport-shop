...
const navigation = {
  ...
  social: [
    {
      name: "Instagram",
      href: "https://www.instagram.com/personalbestsportswear/",
      icon: (props) => (
    ...
    {
      name: "TikTok",
      href: "https://www.tiktok.com/@personalbestsportswear?_r=1&_t=ZS-959VhJoMsam",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-gray-400 text-base leading-relaxed max-w-md">
                Performance-driven activewear designed for movement, comfort,
                and everyday training. Built for those who show up.
              </p>
            </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              &copy; {new Date().getFullYear()} Personal Best Sportswear. All
              rights reserved.
            </p>
